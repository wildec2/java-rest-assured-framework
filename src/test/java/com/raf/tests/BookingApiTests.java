...
public class BookingApiTests extends BaseTest{
    ...
    public void postBookingReturns201(){
        Booking payload = getBookingPayload(LocalDate.of(2025, 11, 7), LocalDate.of(2025, 11, 8));
    ...
    public void deleteBookingReturns202() {
        Booking payload = getBookingPayload(LocalDate.of(2025, 7, 11), LocalDate.of(2025, 7, 14));
